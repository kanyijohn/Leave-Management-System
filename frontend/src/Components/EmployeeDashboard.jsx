            ...
            >
              ...
              <li className="w-100">
                ...
                >
                  ...
                  <span className={`ms-2 d-none d-sm-inline ${isCollapsed ? 'd-none' : ''}`}>My Profile</span>
                </Link>
              </li>

              <li className="w-100">
                <Link
                  to="/employee_dashboard/applyleave"
                  className="nav-link px-0 align-middle text-white"
                >
                  <i className="fs-4 bi-calendar ms-2"></i>
                  <span className={`ms-2 d-none d-sm-inline ${isCollapsed ? 'd-none' : ''}`}> Apply Leave</span>
                </Link>
              </li>
              <li className="w-100">
                <Link
